<div id="promotions" class="section-container bg-white">
	...
	<div class="container">
		...
		<h4 class="section-title clearfix">
			<a href="#" class="pull-right">SHOW ALL</a> Exclusive promotions <small>from
				25 September 2016 - 1 January 2017</small>
		</h4>
		<!-- END section-title -->
		<!-- BEGIN row -->
		<div class="row row-space-10">
			...
			<div class="col-md-6">
				...
				<div class="promotion promotion-lg bg-black-darker">
					<div
						class="promotion-image text-right promotion-image-overflow-bottom">
					...
					<div class="promotion-caption promotion-caption-inverse">
						...
						<p class="promotion-desc">
							A big step for small.<br />A beloved design. Now with more to
							love.
						</p>
			...
			<div class="col-md-3 col-sm-6">
				...
				<div class="promotion bg-blue">
					<div
						class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
				...
				<div class="promotion bg-silver">
					<div
						class="promotion-image text-center promotion-image-overflow-bottom">
			...
			<div class="col-md-3 col-sm-6">
				...
				<div class="promotion bg-silver">
					<div
						class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-right">
						<img src="./assets/img/product/product-mac-accessories.png"
							alt="" />
					</div>
					<div class="promotion-caption text-center">
						...
						<p class="promotion-desc">Redesigned. Rechargeable.
							Remarkable.</p>
						<a href="#" class="promotion-btn">View More</a>
					</div>
				</div>
				...
				<div class="promotion bg-black">
					...
					<div class="promotion-caption promotion-caption-inverse">
						...
						<p class="promotion-desc">Built for creativity on an epic
							scale.</p>
						<a href="#" class="promotion-btn">View More</a>
					</div>
				</div>
